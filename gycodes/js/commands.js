var youtube = "https://www.youtube.com/@9ovindyadav/";
var twitter = "https://www.twitter.com/9ovindyadav/";
var password = "gycodes";
var linkedin = "https://www.linkedin.com/in/govindsvyadav/";
var instagram = "https://www.instagram.com/9ovindyadav/";
var github = "https://github.com/9ovindyadav/";
var email = "mailto:govindsvyadav@gmail.com";
...
whois = [
  ...
  "podcast 'Decoded w/ Govind yadav.' What most people don't know, and will only know",
...
social = [
  ...
  'youtube        <a href="' +
    youtube +
    '" target="_blank">youtube/@9ovindyadav' +
    "</a>",
  'twitter        <a href="' +
    twitter +
    '" target="_blank">twitter/9ovindyadav' +
    "</a>",
  'linkedin       <a href="' +
    linkedin +
    '" target="_blank">linkedin/govindsvyadav' +
    "</a>",
  'instagram      <a href="' +
    instagram +
    '" target="_blank">instagram/9ovindyadav' +
    "</a>",
  'github         <a href="' +
    github +
    '" target="_blank">github/9ovindyadav' +
    "</a>",
  "<br>",
];
...
help = [
  "<br>",
  '<span class="command">whois</span>          Who is Govind?',
...
banner = [
  '<span class="index">GovindYadav (GY) Not A Robot or AI. All rights reserved.</span>',
  "         ___   ____",
  "#####              ",
  "#     #  ####  #    # # #    # #####     #   #   ##   #####    ##   #    #",
  "#       #    # #    # # ##   # #    #     # #   #  #  #    #  #  #  #    # ",
